...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field collaborators on 'Event'
        db.create_table('events_event_collaborators', (
        ...
        db.create_unique('events_event_collaborators', ['event_id', 'participant_id'])


    def backwards(self, orm):
        # Removing M2M table for field collaborators on 'Event'
        db.delete_table('events_event_collaborators')
    ...
    models = {
        ...
        'events.event': {
            ...
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'collaboration_events'", 'symmetrical': 'False', 'to': "orm['participant.Participant']"}),
