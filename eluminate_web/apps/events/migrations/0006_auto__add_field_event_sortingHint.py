...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.sortingHint'
        db.add_column('events_event', 'sortingHint',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.sortingHint'
        db.delete_column('events_event', 'sortingHint')
    ...
    models = {
        ...
        'events.event': {
            ...
            'sortingHint': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
