...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.isEvent'
        db.add_column('events_event', 'isEvent',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.isEvent'
        db.delete_column('events_event', 'isEvent')
    ...
    models = {
        ...
        'events.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isEvent': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
