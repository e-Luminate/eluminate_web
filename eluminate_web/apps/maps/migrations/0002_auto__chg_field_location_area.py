...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maps_location', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Location.area'
        db.alter_column('maps_location', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(default=None))
