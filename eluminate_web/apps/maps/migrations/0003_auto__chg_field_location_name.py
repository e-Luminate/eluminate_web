...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maps_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Location.name'
        db.alter_column('maps_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
