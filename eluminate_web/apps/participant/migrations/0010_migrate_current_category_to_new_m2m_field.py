...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "For each existing Participant, add its current category to the new categories many to many"
        for participant in orm['participant.Participant'].objects.all():
            participant.categories.add(participant.category)
            participant.save()

    def backwards(self, orm):
        "For each existing Participant, clear its categories"
        for participant in orm['participant.Participant'].objects.all():
